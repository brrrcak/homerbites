        ...
        <div id="authModal" class="fixed inset-0 z-50">
            ...
            <div class="fixed inset-0 flex items-center justify-center p-4">
                <div class="relative max-w-md w-full">
                    <div class="absolute -inset-0.5 bg-gradient-to-r from-brand-500 via-accent-500 to-purple-600 rounded-3xl animate-rotate-border"></div>
                    <div class="relative backdrop-blur-2xl bg-slate-800/20 rounded-3xl shadow-2xl animate-scale-in">
